...
public interface MZN2ChocoListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link MZN2ChocoParser#model}.
	 * @param ctx the parse tree
	 */
	void enterModel(MZN2ChocoParser.ModelContext ctx);
	/**
	 * Exit a parse tree produced by {@link MZN2ChocoParser#model}.
	 * @param ctx the parse tree
	 */
	void exitModel(MZN2ChocoParser.ModelContext ctx);
	/**
	 ...
	 * labeled alternative in {@link MZN2ChocoParser}.
	 * @param ctx the parse tree
	 */
